  ...
  $.fn.sbCustomSelect = function(options) {
    ...
    var createDropdown = function($select) {
      ...
      $options.each(function() {
        ...
        var valueName = $(this).attr("title") ? ' title="' + $(this).attr("title") + '"' : '';
        var bangHref = $(this).attr("data-href") ? $(this).attr("data-href") : '';
        
        $dropdown.append('<li' + className + valueName  +'><a href="' + bangHref + '">' + $(this).text() + '</a></li>');
      });
